...
describe('Shadow DOM', () => {
  it('captures shadow dom', () => {
    cy.visit('/cypress/fixtures/shadow-dom-named-slots.html')

    cy.get('button', { includeShadowDom: true }).contains('Food').click()
    ...
    cy.wait(1000)
    cy.get('button', { includeShadowDom: true }).contains('Animals').click()
